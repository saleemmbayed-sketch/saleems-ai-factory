# 🤝 为 Saleem's AI Factory 贡献代码
首先，非常感谢你愿意为 Saleem's AI Factory 贡献力量！正是有像你这样的参与者，才能让这套 AI 智能体集合变得越来越好。
...
- **迭代优化**：根据反馈修改完善
- **通过审核**：维护者确认无误后通过
- **合并上线**：你的贡献正式加入 Saleem's AI Factory！
...
### 新贡献者指南
- [README.md](README.md) —— 项目概览与智能体目录
- [示例：前端开发者](engineering/engineering-frontend-developer.md) —— 结构规范的智能体示例
- [示例：Reddit 社区运营者](marketing/marketing-reddit-community-builder.md) —— 性格塑造优秀示例
- [示例：趣味注入器](design/design-whimsy-injector.md) —— 创意型专家示例
...
## 🎉 再次感谢！
你的每一份贡献都在让 Saleem's AI Factory 变得更好。无论你是：
- 新增智能体
- 完善文档
- 修复错误
- 分享成功案例
