...
convert_zcode() {
  ...
  # identical to the qwen-md shape, which the Saleem's AI Factory app renders natively.
  if [[ -n "$tools" ]]; then
    cat > "$outfile" <<HEREDOC
---
name: ${slug}
...
# Saleem's AI Factory — AI Agent Conventions
#
# This file provides Aider with the full roster of specialized AI agents from
# Saleem's AI Factory (https://github.com/Saleem_Mo/saleems-ai-factory).
#
...
# Saleem's AI Factory — AI Agent Rules for Windsurf
#
# Full roster of specialized AI agents from Saleem's AI Factory.
...
main() {
  ...
  header "Saleem's AI Factory -- Converting agents to tool-specific formats"
  echo "  Repo:   $REPO_ROOT"
  echo "  Output: $OUT_DIR"
  echo "  Tool:   $tool"
  echo "  Date:   $TODAY"
