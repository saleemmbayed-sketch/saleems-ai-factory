...
This agent fills a critical gap between several existing `saleems-ai-factory` roles. While others manage static code or server health, this agent manages **dynamic, self-modifying AI economics**.
