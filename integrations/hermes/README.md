# Hermes Saleem's AI Factory Router Plugin
...
small fixed tool surface at startup, while the complete Saleem's AI Factory roster is
...
When a Hermes project needs Saleem's AI Factory specialists, explicitly ask Hermes to use
the `agency-agents-router` plugin/router and load only the specialists needed for
the current phase. Do not ask Hermes to install or preload the full Saleem's AI Factory
roster as skills.

Recommended project instruction:

```text
Use the agency-agents-router plugin. Search the Saleem's AI Factory roster for the right
...
full Saleem's AI Factory roster and do not add saleems-ai-factory to skills.external_dirs.
```
...
relevant Saleem's AI Factory specialists. Search first, then delegate to selected agents
...
Saleem's AI Factory agents at startup.
```
